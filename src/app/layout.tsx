...
export const metadata: Metadata = {
  title: "Professional House Cleaning | South New Jersey",  description: "Magaly Reyes House Cleaning Services provides expert residential and realtor cleaning solutions across South New Jersey. Get your free quote today.",  keywords: "house cleaning South New Jersey, professional cleaning services, realtor cleaning program, move-out cleaning",  metadataBase: new URL("https://magalysreyes.com"),
  alternates: {
    canonical: "https://magalysreyes.com"
  },
  openGraph: {
    title: "Magaly Reyes House Cleaning Services",    description: "Professional cleaning solutions for South New Jersey homes and businesses. Get a free quote today.",    url: "https://magalysreyes.com",    siteName: "Magaly Reyes House Cleaning",    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3AQ3abHj7nJoV9DleXcQnubKTBh/uploaded-1772602282380-eg5rebjr.png",        alt: "Magaly Reyes House Cleaning Services"
      }
    ],
    type: "website"
  },
  twitter: {
    card: "summary_large_image",    title: "Professional House Cleaning | South New Jersey",    description: "Expert cleaning services and realtor partnerships in South Jersey",    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3AQ3abHj7nJoV9DleXcQnubKTBh/uploaded-1772602282380-eg5rebjr.png"]
  },
  robots: {
    index: true,
    follow: true
